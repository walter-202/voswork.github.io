...
<head>
	...
	<title>VosWork| Admin Paginas</title>
		...
		<div class="content-wrapper">
				...
				<div class="row">
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Seleccionar página</label>
												<div class="col-sm-8">
															   <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                  <option value="" selected="selected" class="form-control">***Elija una***</option>
                  <option value="Administrar-pag.php?type=Términos ">Términos  and condition</option>
                  <option value="Administrar-pag.php?type=privacy">Privacidad y política</option>
                  <option value="Administrar-pag.php?type=nosotros">Nosotros</option> 
                  <option value="Administrar-pag.php?type=faqs">FAQs</option>
                </select>
												</div>
											</div>
			...
			?>
									...
									<div class="form-group">
												...
												<div class="col-sm-8">
			<textarea class="form-control" rows="5" cols="50" name="pgedetails" id="pgedetails" placeholder="Detalles " required>
										<?php 
$pagetype=$_GET['type'];
