...
$sql="UPDATE tbloficinas set Vimage5=:vimage where id=:id";
...
<head>
	...
	<title>VosWork| Admin Actualizar imagen 5</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">office Image 5 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">office Image 5Detalles</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Imagen Actual5</label>
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage5 from tbloficinas where tbloficinas.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Actualizar nueva Imagen 5<span style="color:red">*</span></label>
												<div class="col-sm-8">
