...
$msg="Testimonio inactivo Correctamente";
}
...
$msg="Testimonio Activado en la Pagina principal";
}
...
<head>
	...
	<title>VosWork|Admin Administrar testimonios   </title>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">User testimonios</div>
...
{?>
<a class="action-negative" href="testimonios.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('¿Quieres Activarlo?')"> Desactivado</a>
<?php } else {?>
<a href="testimonios.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('¿Quieres desactivarlo?')"> Activo</a>
</td>
<?php } ?></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
