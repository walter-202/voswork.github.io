    ...
    <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Encuentra Aquí </h5>
          </div>
...
<?php }} ?>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-comments" aria-hidden="true"></i> Recientes</h5>
          </div>
          <div class="recent_addedoff">
            <ul>
<?php 
$sql = "SELECT tbloficinas.*,tblbrands.BrandName,tblbrands.id as bid  from tbloficinas join tblbrands on tblbrands.id=tbloficinas.officesBrand order by id desc limit 4";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
