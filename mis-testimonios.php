  ...
  <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        ...
        <div class="profile_wrap">
          <h5 class="uppercase underline">Testimonios </h5>
              ...
              <li>
                ...
                <div>
                 <p><?php echo htmlentities($result->Testimonial);?> </p>
                   <p><b>Fecha de Publicación :</b><?php echo htmlentities($result->PostingDate);?> </p>
                </div>
                <?php if($result->status==1){ ?>
                 <div class="office_status"> <a class="btn outline btn-xs active-btn">Visible</a>

                  <div class="clearfix"></div>
                  </div>
                  <?php } else {?>
               <div class="office_status"> <a href="#" class="btn outline btn-xs">Esperando Aprobación</a>
                  <div class="clearfix"></div>
                  </div>
                  <?php } ?>
              </li>
