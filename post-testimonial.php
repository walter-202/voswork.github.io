...
if($lastInsertId)
{
$msg="Testimonio Enviado a Revisión";
}
else 
{
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Mandar Testimonio</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="index.php">Inicio</a></li>
        <li>Mandar Testimonio</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Mandar un Testimonio</h5>
          ...
          <form  method="post">
            ...
            <div class="form-group">
              <label class="control-label">Testimonios</label>
              <textarea class="form-control white_bg" name="testimonial" rows="3" required="" placeholder="Mándanos un corto testimonio sobre los servicios de nuestra empresa"></textarea>
            </div>
            <div class="form-group">
              <button type="submit" name="submit" class="btn">Guardar  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
