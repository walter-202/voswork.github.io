    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Configuración General</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>LISTO</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Número de Telefono</label>
            ...
            <div class="form-group">
              <label class="control-label">Día de Nacimiento&nbsp;(dd/mm/yyyy)</label>
            ...
            <div class="form-group">
              <label class="control-label">Tu Dirección</label>
              <textarea class="form-control white_bg" name="address" rows="2" ><?php echo htmlentities($result->Address);?></textarea>
            </div>
            <div class="form-group">
